      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
            <form role="form" method="POST" action="updateJabatan.php">
            <?php
                include "koneksi2.php";
                $id_jabatan = $_GET['id_jabatan'];
                $query_mysql = mysqli_query($host,"SELECT * FROM jabatan WHERE id_jabatan='$id_jabatan'")or die(mysqli_error());
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="jabatan" class="form-control" placeholder="Nama Jabatan" value="<?php echo $data['jabatan'];?>">
                      </div>
                    </div>
                  </div>
                <?php } ?>
