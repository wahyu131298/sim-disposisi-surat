              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    include "koneksi2.php";
                      ...
                      INNER JOIN jabatan ON disposisi.dari = jabatan.id_jabatan ORDER BY disposisi.tgl_disposisi DESC";
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                    ...
                    <a href="cetak_disposisi.php?id_disposisi=<?php echo $data['id_disposisi'] ?>"  style="color:white" class="btn btn-success btn-sm" title="Print"><i class="fas fa-print"></i></a>
                  </td>
                </tr>
